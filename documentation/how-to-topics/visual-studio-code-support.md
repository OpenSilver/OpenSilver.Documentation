...
Also you require (if not intalled the extension will try to install it for you) the **.net framework 8 SDK and the blazor wasm workload**.
...
Depending on you specific configuration and environment more steps may be necessary.
